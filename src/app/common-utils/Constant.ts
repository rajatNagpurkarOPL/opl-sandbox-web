...
export const Constant = {
    ...
    MASTER_CODE : {
        ...
        GET_FARMER_DATA_BY_FID : "GET_FARMER_DATA_BY_FID",
        GET_FARMER_DATA_BY_HASH_OF_AADHAR : "GET_FARMER_DATA_BY_HASH_OF_AADHAR",
        CHECK_BHOOMI_STATUS : "CHECK_BHOOMI_STATUS",
