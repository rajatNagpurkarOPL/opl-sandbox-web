...
months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun','Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  manuallyCertificate() {
    this.manuallyCertificateForm = this.fb.group({
      ...
      fileName: new FormControl('', [Validators.required,Validators.pattern('^[ .a-zA-Z0-9:-]{1,150}$')]),
      //createdDate: new FormControl('', [Validators.required]),
      algorithm: new FormControl('', [Validators.required]),
      keySize: new FormControl('', [Validators.required]),
      organizationName: new FormControl('', [Validators.required,Validators.pattern('^[ .a-zA-Z0-9:-]{1,150}$')]),
      organizationUnitName: new FormControl('', [Validators.required,Validators.pattern('^[ .a-zA-Z0-9:-]{1,150}$')]),
      country: new FormControl({ value: 'IN', disabled: true }, [Validators.required]),
      state: new FormControl('', [Validators.required,Validators.pattern('^[ .a-zA-Z0-9:-]{1,150}$')]),
      locality: new FormControl('', [Validators.required,Validators.pattern('^[ .a-zA-Z0-9:-]{1,150}$')]),
      //publicKeyName: new FormControl('', [Validators.required]),
      //privateKeyName: new FormControl('', [Validators.required]),
      commonName: new FormControl('', [Validators.required,Validators.minLength(3),Validators.pattern('^[ .a-zA-Z0-9:-]{1,150}$')]),
