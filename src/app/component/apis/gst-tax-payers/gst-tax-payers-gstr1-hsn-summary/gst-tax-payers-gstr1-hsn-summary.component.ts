...
@Component({
  selector: 'app-gst-tax-payers-gstr1-hsn-summary',
  templateUrl: './gst-tax-payers-gstr1-hsn-summary.component.html',
  styleUrls: ['./gst-tax-payers-gstr1-hsn-summary.component.scss']
})
export class GstTaxPayersGstr1HsnSummaryComponent implements OnInit {
  @Input() menuData: any;
  url : string = null;
  taxPayersForm: FormGroup;
  response : any="Response Will be Rendered Here.";
  type: any = ["MONTH", "MONTH_RANGE"];
  apiType = "GSTR1_HSN_SUMMARY";
