...
@Component({
  selector: 'app-gst-tax-payers-gstr2-cdnur',
  templateUrl: './gst-tax-payers-gstr2-cdnur.component.html',
  styleUrls: ['./gst-tax-payers-gstr2-cdnur.component.scss']
})
export class GstTaxPayersGstr2CdnurComponent implements OnInit {
  @Input() menuData: any;
  url : string = null;
