...
@Component({
  selector: 'app-gst-tax-payers-gstr2-summary',
  templateUrl: './gst-tax-payers-gstr2-summary.component.html',
  styleUrls: ['./gst-tax-payers-gstr2-summary.component.scss']
})
export class GstTaxPayersGstr2SummaryComponent implements OnInit {
  @Input() menuData: any;
