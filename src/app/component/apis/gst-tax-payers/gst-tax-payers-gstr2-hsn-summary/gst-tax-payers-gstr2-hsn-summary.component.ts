...
@Component({
  selector: 'app-gst-tax-payers-gstr2-hsn-summary',
  templateUrl: './gst-tax-payers-gstr2-hsn-summary.component.html',
  styleUrls: ['./gst-tax-payers-gstr2-hsn-summary.component.scss']
})
export class GstTaxPayersGstr2HsnSummaryComponent implements OnInit {
  @Input() menuData: any;
