...
@Component({
  selector: 'app-gst-tax-payers-gstr1-cdnur',
  templateUrl: './gst-tax-payers-gstr1-cdnur.component.html',
  styleUrls: ['./gst-tax-payers-gstr1-cdnur.component.scss']
})
export class GstTaxPayersGstr1CdnurComponent implements OnInit {
  @Input() menuData: any;
