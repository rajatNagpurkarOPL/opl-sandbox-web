...
@Component({
  selector: 'app-gst-tax-payers-gstr2a-cdn',
  templateUrl: './gst-tax-payers-gstr2a-cdn.component.html',
  styleUrls: ['./gst-tax-payers-gstr2a-cdn.component.scss']
})
export class GstTaxPayersGstr2aCdnComponent implements OnInit {
  @Input() menuData: any;
  url : string = null;
