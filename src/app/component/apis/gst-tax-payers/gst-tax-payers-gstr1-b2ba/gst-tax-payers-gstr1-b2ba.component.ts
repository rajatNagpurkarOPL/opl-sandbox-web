...
@Component({
  selector: 'app-gst-tax-payers-gstr1-b2ba',
  templateUrl: './gst-tax-payers-gstr1-b2ba.component.html',
  styleUrls: ['./gst-tax-payers-gstr1-b2ba.component.scss']
})
export class GstTaxPayersGstr1B2baComponent implements OnInit {
  ...
  onFormSubmit(){
    if(this.taxPayersForm.valid){
      ...
      this.sandboxService.getGstTaxPayersGSTR1B2BAData(this.url ,payload ,headers).subscribe(res => {
