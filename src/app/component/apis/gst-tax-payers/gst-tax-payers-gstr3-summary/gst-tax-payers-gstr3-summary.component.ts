...
@Component({
  selector: 'app-gst-tax-payers-gstr3-summary',
  templateUrl: './gst-tax-payers-gstr3-summary.component.html',
  styleUrls: ['./gst-tax-payers-gstr3-summary.component.scss']
})
export class GstTaxPayersGstr3SummaryComponent implements OnInit {
  @Input() menuData: any;
