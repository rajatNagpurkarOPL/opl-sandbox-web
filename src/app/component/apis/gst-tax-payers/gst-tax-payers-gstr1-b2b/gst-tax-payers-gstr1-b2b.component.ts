...
@Component({
  selector: 'app-gst-tax-payers-gstr1-b2b',
  templateUrl: './gst-tax-payers-gstr1-b2b.component.html',
  styleUrls: ['./gst-tax-payers-gstr1-b2b.component.scss']
})
export class GstTaxPayersGstr1B2bComponent implements OnInit {
  ...
  onFormSubmit(){
    if(this.taxPayersForm.valid){
      ...
      this.sandboxService.getGstTaxPayersGSTR1B2BData(this.url ,payload ,headers).subscribe(res => {
