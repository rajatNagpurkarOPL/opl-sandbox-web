...
@Component({
  selector: 'app-gst-tax-payers-gstr1-summary',
  templateUrl: './gst-tax-payers-gstr1-summary.component.html',
  styleUrls: ['./gst-tax-payers-gstr1-summary.component.scss']
})
