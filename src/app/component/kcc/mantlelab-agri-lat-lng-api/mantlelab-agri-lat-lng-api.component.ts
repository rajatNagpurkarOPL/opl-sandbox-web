...
@Component({
  selector: 'app-mantlelab-agri-lat-lng-api',
  templateUrl: './mantlelab-agri-lat-lng-api.component.html',
  styleUrls: ['./mantlelab-agri-lat-lng-api.component.scss']
})
export class MantlelabAgriLatLngApiComponent implements OnInit {
  @Input() menuData: any;
